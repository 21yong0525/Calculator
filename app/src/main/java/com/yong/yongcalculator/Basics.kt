...
class Basics : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.tv0.setOnClickListener { appendNumber(0, binding) }
        binding.tv1.setOnClickListener { appendNumber(1, binding) }
        binding.tv2.setOnClickListener { appendNumber(2, binding) }
        binding.tv3.setOnClickListener { appendNumber(3, binding) }
        binding.tv4.setOnClickListener { appendNumber(4, binding) }
        binding.tv5.setOnClickListener { appendNumber(5, binding) }
        binding.tv6.setOnClickListener { appendNumber(6, binding) }
        binding.tv7.setOnClickListener { appendNumber(7, binding) }
        binding.tv8.setOnClickListener { appendNumber(8, binding) }
        binding.tv9.setOnClickListener { appendNumber(9, binding) }
...
fun appendNumber(num: Int, binding: FtBasicsBinding) {
    if (arithmetic != true){
